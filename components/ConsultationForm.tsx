  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" aria-label="Book a free consultation">
      <div className="grid sm:grid-cols-2 gap-5">
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-ink-700 dark:text-cream mb-1.5">
            Name
          </label>
          <input
            id="name"
        ...
        <div>
          <label htmlFor="business" className="block text-sm font-medium text-ink-700 dark:text-cream mb-1.5">
            Business name
          </label>
          <input
            id="business"
      ...
      <div className="grid sm:grid-cols-2 gap-5">
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-ink-700 dark:text-cream mb-1.5">
            Email
          </label>
          <input
            id="email"
        ...
        <div>
          <label htmlFor="phone" className="block text-sm font-medium text-ink-700 dark:text-cream mb-1.5">
            Phone (optional)
          </label>
          <input
            id="phone"
      ...
      <div>
        <label htmlFor="message" className="block text-sm font-medium text-ink-700 dark:text-cream mb-1.5">
      ...
      <label className="flex items-start gap-3 text-xs text-ink-400 dark:text-cream/70">
      ...
      <button
        type="submit"
        className="w-full sm:w-auto rounded-lg bg-plum hover:bg-plum-600 text-cream text-sm font-semibold px-8 py-3 transition-colors"
      >
