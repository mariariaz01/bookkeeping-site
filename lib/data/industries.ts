...
export const industries: Industry[] = [
  {
    ...
    intro: "Consulting businesses are often lean, which means bookkeeping needs to be too. COUNTRA keeps things simple: invoices tracked, expenses categorized, and books ready whenever you need them.",
  ...
  },
  {
    ...
    intro: "Agencies juggle retainers, one-off projects, and a bench of subcontractors. COUNTRA builds books that show you what's actually profitable, not just what's billed.",
  ...
  },
  {
    ...
    shortDescription: "Multi-project tracking, subcontractor T4A prep, and books that hold up to PWGSC and prime-contractor reporting requirements.",
    metaTitle: "Bookkeeping for Government Contractors | Canadian Bookkeeping Specialists",
    metaDescription: "Bookkeeping for federal government contractors and subcontractors in Canada — multi-project tracking, T4A prep, and prime-contractor-ready reporting.",
    intro: "Government contract work comes with its own reporting expectations. COUNTRA tracks each contract separately and keeps your books ready to stand up to PWGSC and prime-contractor scrutiny.",
    points: ["Multi-project and multi-contract tracking", "Subcontractor T4A preparation", "Books structured for prime-contractor and PWGSC reporting", "Support for incorporated consultants and small agencies"],
    tier: "primary",
  },
  {
    slug: "startups",
    ...
    intro: "Startups need books that hold up to investor scrutiny without the cost of a full finance team. COUNTRA builds clean, scalable bookkeeping from the earliest stage.",
  ...
  },
  {
    ...
    shortDescription: "Job costing, holdbacks, and cash flow that keeps pace with tools, trucks, and seasonal work.",
    metaTitle: "Bookkeeping for Contractors & Trades | Canadian Bookkeeping Specialists",
    metaDescription: "Bookkeeping built around job costs, holdbacks, vehicle expenses, and seasonal cash flow for Canadian contractors and trades businesses.",
    intro: "Contracting and trades income doesn't arrive on a neat monthly schedule, and neither do the expenses. COUNTRA tracks job costs and cash flow in a way that actually reflects how contracting and trades businesses run.",
    points: ["Job costing by project", "Holdback and progress billing tracking", "Vehicle, tool, and equipment expense tracking", "Seasonal cash flow reporting", "GST/HST on contract work"],
    tier: "secondary",
  },
  {
    slug: "real-estate",
    ...
    intro: "Whether you're a realtor tracking commissions or an investor tracking properties, real estate bookkeeping needs its own structure. COUNTRA builds books around how your income actually works.",
  ...
  },
  {
    ...
    intro: "Medical professionals often bill through a mix of provincial health plans, clinics, and private pay. COUNTRA keeps all of it organized and reconciled, professional corporation included.",
  ...
  },
  {
    ...
    intro: "Running a dental practice means tracking equipment financing, staff payroll, and supplier accounts alongside patient billing. COUNTRA keeps every part of it reconciled.",
  ...
  },
  {
    ...
    intro: "COUNTRA handles general account bookkeeping for law firms and sole practitioners, keeping firm operating finances clean and organized so you can focus on your trust obligations separately.",
  ...
  },
  {
    ...
    intro: "Restaurant margins are thin, so the details matter. COUNTRA reconciles daily sales, tracks tips accurately, and keeps a close eye on food and labour costs.",
  ...
  },
  {
    ...
    intro: "Retail bookkeeping has to account for inventory, not just cash in and out. COUNTRA reconciles your POS system and keeps your reporting aligned with what's actually on the shelf.",
  ...
  },
  {
    ...
    intro: "E-commerce sales come with platform fees, shipping costs, and sales tax that varies by province. COUNTRA reconciles it all and keeps your true margins visible.",
