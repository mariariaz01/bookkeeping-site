...
export default function NotFound() {
  return (
    <section className="max-w-content mx-auto px-6 py-24 text-center">
      <p className="font-mono text-gold-600 text-sm">404</p>
      <h1 className="mt-3 font-display font-extrabold text-3xl text-plum dark:text-cream">This page doesn't exist</h1>
      <p className="mt-3 text-ink-400 dark:text-cream/70 max-w-sm mx-auto">
